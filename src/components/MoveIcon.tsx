// Small presentational helpers shared by the trainer list and trainer detail views.

export function DamageClassIcon({ damageClass }: { damageClass?: string }) {
    if (damageClass === "physical") {
        return (
            <svg
                style={{ width: "16px", height: "16px", background: "#f85131", borderRadius: "4px", padding: "4px", color: "#ffc631" }}
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="0.75em" height="1em" viewBox="0 0 384 512"
            >
    ...
    if (damageClass === "special") {
        return (
            <svg
                style={{ width: "16px", height: "16px", background: "#5273ad", borderRadius: "4px", padding: "4px", color: "#bbd1f1" }}
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256"
            >
    ...
    return (
        <svg
            style={{ width: "16px", height: "16px", background: "#ada594", borderRadius: "4px", padding: "4px", color: "white" }}
            xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256"
        >
            <path fill="currentColor" d="M140 80a12 12 0 1 1-12-12a12 12 0 0 1 12 12Zm92 48A104 104 0 1 1 128 24a104.2 104.2 0 0 1 104 104Zm-92 48a12 12 0 1 0-12 12a12 12 0 0 0 12-12Zm32-92a44 44 0 0 0-44-44a88 88 0 0 0-46.9 162.4A51.1 51.1 0 0 1 76 180a52 52 0 0 1 52-52a44 44 0 0 0 44-44Z" />
        </svg>
    );
}
